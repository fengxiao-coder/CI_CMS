 ...
 <?php if ($id){?>
  		<ul id="tag">
                      <li <?php if( 'all' == $current_type ){ ?> class="current"<?php } ?> >
							<a href="<?php echo base_url($this->_site_path . '/search/lists')."/".$id;?>">全部</a>
					  </li>
					   <li <?php if( 'sales' == $current_type ){ ?> class="current"<?php } ?> >
							<a href="<?php echo base_url($this->_site_path . '/search/filter')."/".$id."/sales"."?brand_id=".$brand_id."&&"."price_big=".$price_big."&&"."price_small=".$price_small?>">销量</a>
					  </li>
					   <li <?php if( 'price' == $current_type ){ ?> class="current"<?php } ?> >
							<a href="<?php echo base_url($this->_site_path . '/search/filter')."/".$id."/price"."?brand_id=".$brand_id."&&"."price_big=".$price_big."&&"."price_small=".$price_small?>">价格</a>
					  </li>					
        </ul>    
  <?php }else {?>
  			<ul id="tag">
                       <li <?php if( 'all' == $current_type ){ ?> class="current"<?php } ?> >
							<a href="<?php echo base_url($this->_site_path . '/search/lists');?>">全部</a>
					  </li>
					   <li <?php if( 'sales' == $current_type ){ ?> class="current"<?php } ?> >
							<a href="<?php echo base_url($this->_site_path . '/search/screen')."/sales"."?brand_id=".$brand_id."&&"."price_big=".$price_big."&&"."price_small=".$price_small?>">销量</a>
					  </li>
					   <li <?php if( 'price' == $current_type ){ ?> class="current"<?php } ?> >
							<a href="<?php echo base_url($this->_site_path . '/search/screen')."/price"."?brand_id=".$brand_id."&&"."price_big=".$price_big."&&"."price_small=".$price_small?>">价格</a>
					  </li>					
            </ul>  
  <?php }?>
   ...
   <!--点击筛选弹出tag_showbox-->
        <div class="tag_box"><a class="tag_check" id="check">筛选</a></div>
