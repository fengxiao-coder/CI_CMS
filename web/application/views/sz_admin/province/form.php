	...
	<form method="post">
		...
		<label class="control-label" for="<?php echo $k?>"><?php echo $v ?></label>
			<div class="controls">
				...
				value="<?php echo isset( $province_data[$k] ) ? $province_data[$k] : '' ; ?>">
			</div>
		</div>
		<?php endforeach;?>
		<div class="control-group control-group-submit">
			<button type="submit" class="btn  btn-blue  floa-Left"><?php echo isset($province_data['province_id'])?'修改':'添加';?></button>
