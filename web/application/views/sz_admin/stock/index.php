...
<?php $this->load->view_part($this->_site_path."/stock/search")?>

<form method="post" action="<?php echo base_url($this->_site_path."/stock/delete_all");?>">
	...
	<table class="table table-striped table-condensed table-bordered">
		...
		<tbody>
			<?php foreach( $stock_data as $single ) { ?>
			<tr>
				<td>
                ...
                <?php endforeach;?>
				<td>
					<a href="<?php echo base_url($this->_site_path."/stock/view/{$single['id']}"); ?>">查看</a>
					<a href="<?php echo base_url($this->_site_path."/stock/edit/{$single['id']}"); ?>">修改</a>
					<a href="<?php echo base_url($this->_site_path."/stock/delete/{$single['id']}"); ?>" onclick="return confirmDelete()">删除</a>
				</td>
			</tr>
		<?php } ?>
	</tbody>
