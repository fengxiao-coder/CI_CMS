        ...
        <form method="post">
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="addinfo_table">
                ...
                <tr>
                    ...
                    <td width="37%"><input type="text" name="<?php echo $k ?>" id="<?php echo $k ?>" placeholder="" class="x_inpt_border" value="<?php echo isset( $user_rank_data[$k] ) ? $user_rank_data[$k] : '' ; ?>"><span class="span">*</span></td>
                </tr>
                <?php endforeach; ?>
            </table>
