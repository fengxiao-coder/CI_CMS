...
<div class="list_box">
	...
	<table class="table table-striped table-condensed table-bordered">
		...
		<?php foreach ($store_data as $single){?>
			<tr>		
				<td><?php echo $single["goods_name"]?></td> 	
				<td><?php echo $this->store_model->get_value_by_pk($single["store_id"],"sName")?></td>					                   				
				<td><?php echo $single["goods_sn"]?></td>
				<td><?php echo $single["sum(goods_number)"]?></td>
				<td>￥<?php echo $single["sum(goods_number)"]*$single["price"]?>元</td>
			</tr>
		<?php }?>
	</tbody>
	</table>
