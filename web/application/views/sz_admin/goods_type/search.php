    ...
    <form method="get">
        ...
        <div class="search_group_right float_clear initial">
            ...
            <div class="search">
                ...
                <input type="text" name="type_name_like" value="<?php echo $this->input->get('type_name_like'); ?>" class=" input_medium search_query" />
            </div>
            
            <div class="search">
                <label class="control_label" >备注</label>
                <input type="text" name="remark_like" value="<?php echo $this->input->get('remark_like'); ?>" class=" input_medium search_query" />
            </div>
            
            <div class="search">
                <label class="control_label" >排序</label>
                <input type="text" name="sort_like" value="<?php echo $this->input->get('sort_like'); ?>" class=" input_medium search_query" />
            </div>
