    ...
    <form method="get">
        ...
        <div class="search_group_right float_clear initial">
            ...
            <div class="search">
                ...
                <input type="text" name="title_like" value="<?php echo $this->input->get('title_like'); ?>" class=" input_medium search_query" />
            </div>
            
            <div class="search">
                <label class="control_label" >内容</label>
                <input type="text" name="content_like" value="<?php echo $this->input->get('content_like'); ?>" class=" input_medium search_query" />
            </div>
            
            <div class="search">
                <label class="control_label" >关键字</label>
                <input type="text" name="keywords_like" value="<?php echo $this->input->get('keywords_like'); ?>" class=" input_medium search_query" />
            </div>
            
            <div class="search">
                <label class="control_label" >备注</label>
                <input type="text" name="description_like" value="<?php echo $this->input->get('description_like'); ?>" class=" input_medium search_query" />
            </div>
