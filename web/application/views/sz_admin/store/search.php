    ...
    <form method="get">
        ...
        <div class="search_group_right float_clear initial">
            ...
            <div class="search">
                ...
                <input type="text" name="sName_like" value="<?php echo $this->input->get('sName_like'); ?>" class=" input_medium search_query" />
            </div>     
            <div class="search">
                <label class="control_label" >联系人</label>
                <input type="text" name="sUser_like" value="<?php echo $this->input->get('sUser_like'); ?>" class=" input_medium search_query" />
            </div>  
            <div class="search">
                <label class="control_label" >邀请码</label>
                <input type="text" name="bar_code_like" value="<?php echo $this->input->get('bar_code_like'); ?>" class=" input_medium search_query" />
            </div>
