    ...
    <form method="get">
        ...
        <div class="search_group_right float_clear initial">
            ...
            <div class="search">
                ...
                <input type="text" name="user_name_like" value="<?php echo $this->input->get('user_name'); ?>" class=" input_medium search_query" />
            </div>     
            <div class="search">
                <label class="control_label" >商品名称</label>
                <input type="text" name="goods_name_like" value="<?php echo $this->input->get('goods_name'); ?>" class=" input_medium search_query" />
            </div>  
            <div class="search">
                <label class="control_label" >评论内容</label>
                <input type="text" name="content_like" value="<?php echo $this->input->get('content'); ?>" class=" input_medium search_query" />
            </div>  
